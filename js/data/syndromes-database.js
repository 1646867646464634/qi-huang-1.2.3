...
,
    ...
    {
        id: "syn_150", name: "血瘀证", category: "气血津液辨证", pattern: "血瘀证",
        symptoms: ["刺痛拒按","痛处固定","夜间痛甚","面色黧黑","唇甲青紫","肌肤甲错","或见肿块","舌质紫暗或有瘀点瘀斑"],
        tongueAppearance: {"tongueBody":"紫暗或有瘀点瘀斑","tongueCoating":"苔薄白"},
        pulseCondition: "脉细涩或结代",
        etiology: "气滞、气虚、寒凝、热灼或外伤等致血行不畅，瘀滞脉络",
        pathogenesis: "瘀血内停，阻滞脉络，不通则痛",
        treatmentPrinciple: "活血祛瘀，通络止痛",
        treatmentMethod: "活血化瘀，行气止痛",
        recommendedFormulas: [{"id":"formula_109","name":"桃红四物汤","matchScore":90},{"id":"formula_110","name":"失笑散","matchScore":85},{"id":"formula_111","name":"膈下逐瘀汤","matchScore":80},{"id":"formula_113","name":"活络效灵丹","matchScore":75}],
        relatedConstitutions: ["血瘀质"],
        keyPoints: ["刺痛拒按","痛处固定","舌质紫暗或有瘀点瘀斑","脉细涩"]
    },
    {
        id: "syn_151", name: "心肾不交证", category: "脏腑辨证", pattern: "心肾不交证",
        symptoms: ["心烦失眠","心悸健忘","头晕耳鸣","腰膝酸软","多梦遗精","五心烦热","口燥咽干"],
        tongueAppearance: {"tongueBody":"红","tongueCoating":"少苔"},
        pulseCondition: "脉细数",
        etiology: "思虑太过，或久病伤阴，肾水亏虚不能上济心火，心火亢盛不能下交于肾",
        pathogenesis: "肾水不足，心火偏亢，水火不济，心肾失交",
        treatmentPrinciple: "滋阴降火，交通心肾",
        treatmentMethod: "滋阴清热，宁心安神，引火归元",
        recommendedFormulas: [{"id":"formula_042","name":"天王补心丹","matchScore":90},{"id":"formula_247","name":"交泰丸","matchScore":85}],
        relatedConstitutions: ["阴虚质","气郁质"],
        keyPoints: ["心烦失眠","心悸健忘","腰膝酸软","五心烦热"]
    },
    {
        id: "syn_152", name: "痰气互结证", category: "气血津液辨证", pattern: "痰气郁结证",
        symptoms: ["咽中如有物梗阻","咯吐不出","吞咽不下","胸胁满闷","情志抑郁","善太息","或见瘿瘤瘰疬"],
        tongueAppearance: {"tongueBody":"淡红","tongueCoating":"苔白腻"},
        pulseCondition: "脉弦滑",
        etiology: "情志不遂，肝气郁结，津聚成痰，痰气搏结于咽喉或局部",
        pathogenesis: "气郁痰凝，搏结于咽或经络，阻滞气机",
        treatmentPrinciple: "行气散结，降逆化痰",
        treatmentMethod: "疏肝理气，化痰散结",
        recommendedFormulas: [{"id":"formula_047","name":"半夏厚朴汤","matchScore":90},{"id":"formula_234","name":"海藻玉壶汤","matchScore":85}],
        relatedConstitutions: ["气郁质","痰湿质"],
        keyPoints: ["咽中如有物梗阻","胸胁满闷","苔白腻","脉弦滑"]
    },
    {
        id: "syn_153", name: "气虚血瘀证", category: "气血津液辨证", pattern: "气虚血瘀证",
        symptoms: ["神疲乏力","气短懒言","半身不遂","肢体麻木","肌肤不仁","或见疼痛拒按","舌淡紫或有瘀斑"],
        tongueAppearance: {"tongueBody":"淡紫或有瘀斑","tongueCoating":"苔薄白"},
        pulseCondition: "脉细涩无力",
        etiology: "久病或年老气虚，运血无力，血行瘀滞",
        pathogenesis: "气虚无力行血，血瘀脉络，肢体失养",
        treatmentPrinciple: "补气活血，通络化瘀",
        treatmentMethod: "益气活血，化瘀通络",
        recommendedFormulas: [{"id":"formula_051","name":"补阳还五汤","matchScore":90},{"id":"formula_257","name":"黄芪桂枝五物汤","matchScore":85}],
        relatedConstitutions: ["气虚质","血瘀质"],
        keyPoints: ["神疲乏力","半身不遂","舌淡紫或有瘀斑","脉细涩无力"]
    },
    {
        id: "syn_154", name: "温燥伤肺证", category: "脏腑辨证", pattern: "外燥证",
        symptoms: ["干咳无痰","或痰少而黏","咯痰不爽","鼻咽干燥","皮肤干燥","发热微恶风寒","口渴","头痛少汗"],
        tongueAppearance: {"tongueBody":"红","tongueCoating":"苔薄白而干或薄黄而干"},
        pulseCondition: "脉浮数",
        etiology: "秋令感受温燥之邪，侵袭肺卫，耗伤肺津",
        pathogenesis: "温燥犯肺，肺失清肃，津液耗伤",
        treatmentPrinciple: "清宣温燥，润肺止咳",
        treatmentMethod: "轻宣凉润，清肺化痰",
        recommendedFormulas: [{"id":"formula_060","name":"清燥救肺汤","matchScore":90},{"id":"formula_086","name":"桑杏汤","matchScore":85}],
        relatedConstitutions: ["阴虚质"],
        keyPoints: ["干咳无痰","鼻咽干燥","苔薄白而干","脉浮数"]
    },
    {
        id: "syn_155", name: "暑湿证", category: "八纲辨证", pattern: "暑湿证",
        symptoms: ["身热烦渴","汗出","小便不利","或泄泻","头身困重","胸脘痞闷","舌红苔腻"],
        tongueAppearance: {"tongueBody":"红","tongueCoating":"苔白腻或黄腻"},
        pulseCondition: "脉濡数",
        etiology: "夏月感受暑湿之邪，或贪凉饮冷，暑湿内蕴",
        pathogenesis: "暑湿内蕴，气机受阻，清浊不分",
        treatmentPrinciple: "清暑利湿",
        treatmentMethod: "清热解暑，化湿利水",
        recommendedFormulas: [{"id":"formula_242","name":"六一散","matchScore":90},{"id":"formula_243","name":"桂苓甘露散","matchScore":85}],
        relatedConstitutions: ["湿热质","痰湿质"],
        keyPoints: ["身热烦渴","小便不利","头身困重","苔腻"]
    },
    {
        id: "syn_156", name: "肝郁脾虚证", category: "脏腑辨证", pattern: "肝脾不调证",
        symptoms: ["胸胁胀满疼痛","善太息","情志抑郁","纳呆腹胀","便溏","肠鸣矢气","或腹痛泄泻","泻后痛减"],
        tongueAppearance: {"tongueBody":"淡红","tongueCoating":"苔白"},
        pulseCondition: "脉弦缓或弦细",
        etiology: "情志不遂，肝气郁结，横逆犯脾，脾失健运",
        pathogenesis: "肝郁气滞，脾失健运，气机升降失常",
        treatmentPrinciple: "疏肝解郁，健脾养血",
        treatmentMethod: "疏肝健脾，调和肝脾",
        recommendedFormulas: [{"id":"formula_014","name":"逍遥散","matchScore":90},{"id":"formula_015","name":"痛泻要方","matchScore":85}],
        relatedConstitutions: ["气郁质"],
        keyPoints: ["胸胁胀满疼痛","善太息","纳呆腹胀","便溏"]
    },
    {
        id: "syn_157", name: "热入营分证", category: "卫气营血辨证", pattern: "营分证",
        symptoms: ["身热夜甚","口干反不甚渴饮","心烦不寐","时有谵语","斑疹隐隐","或见衄血"],
        tongueAppearance: {"tongueBody":"红绛","tongueCoating":"少苔或无苔"},
        pulseCondition: "脉细数",
        etiology: "温热之邪内传入营，或气分热盛波及营分",
        pathogenesis: "热入营分，营阴受损，心神被扰",
        treatmentPrinciple: "清营解毒，透热养阴",
        treatmentMethod: "清营泄热，凉血养阴",
        recommendedFormulas: [{"id":"formula_019","name":"清营汤","matchScore":95}],
        relatedConstitutions: ["阴虚质"],
        keyPoints: ["身热夜甚","心烦不寐","斑疹隐隐","舌红绛"]
    },
    {
        id: "syn_158", name: "气阴两虚证", category: "气血津液辨证", pattern: "气阴两虚证",
        symptoms: ["神疲乏力","气短懒言","汗多口渴","咽干舌燥","干咳少痰","心烦","面色潮红或淡白"],
        tongueAppearance: {"tongueBody":"红少津","tongueCoating":"少苔或薄白"},
        pulseCondition: "脉虚细数或虚大",
        etiology: "热病后期，或久病耗伤，气阴两亏",
        pathogenesis: "气虚无以固摄温养，阴虚生内热，津气两伤",
        treatmentPrinciple: "益气养阴，生津敛汗",
        treatmentMethod: "益气养阴，清热生津",
        recommendedFormulas: [{"id":"formula_079","name":"生脉散","matchScore":90},{"id":"formula_018","name":"竹叶石膏汤","matchScore":85}],
        relatedConstitutions: ["气虚质","阴虚质"],
        keyPoints: ["神疲乏力","气短懒言","汗多口渴","咽干舌燥"]
    },
    {
        id: "syn_159", name: "正虚毒恋证", category: "气血津液辨证", pattern: "虚证疮疡",
        symptoms: ["疮疡肿毒","脓成难溃","或溃后脓水清稀","疮口久不收敛","神倦食少","面色萎黄"],
        tongueAppearance: {"tongueBody":"淡","tongueCoating":"苔薄白"},
        pulseCondition: "脉虚无力",
        etiology: "气血亏虚，正虚不能托毒外出，毒邪留恋",
        pathogenesis: "正虚托毒无力，脓毒难泄，疮口难敛",
        treatmentPrinciple: "托毒透脓，补益气血",
        treatmentMethod: "益气养血，托毒溃脓",
        recommendedFormulas: [{"id":"formula_236","name":"透脓散","matchScore":95}],
        relatedConstitutions: ["气虚质"],
        keyPoints: ["脓成难溃","疮口久不收敛","神倦食少","脉虚无力"]
    },
    {
        id: "syn_160", name: "蛔厥证", category: "脏腑辨证", pattern: "虫厥证",
        symptoms: ["阵发腹痛","痛剧时四肢厥冷","痛止则安","吐蛔或便蛔","呕吐清水","面黄体瘦","发作有时"],
        tongueAppearance: {"tongueBody":"淡红","tongueCoating":"苔白"},
        pulseCondition: "脉弦或乍大乍小",
        etiology: "肠道蛔虫扰动，钻入胆道或胃肠，气机逆乱",
        pathogenesis: "蛔虫上扰，气机逆乱，四肢失温",
        treatmentPrinciple: "安蛔止痛，温脏补虚",
        treatmentMethod: "温脏安蛔，驱虫止痛",
        recommendedFormulas: [{"id":"formula_068","name":"乌梅丸","matchScore":95}],
        relatedConstitutions: ["气虚质"],
        keyPoints: ["阵发腹痛","四肢厥冷","吐蛔或便蛔","发作有时"]
    }
...
const syndromeEnhancements = {
    ...
    "syn_150": { keySymptoms: ["刺痛拒按","痛处固定","舌质紫暗或有瘀点瘀斑"] },
    "syn_151": { keySymptoms: ["心烦失眠","心悸健忘","腰膝酸软"] },
    "syn_152": { keySymptoms: ["咽中如有物梗阻","胸胁满闷","情志抑郁"] },
    "syn_153": { keySymptoms: ["神疲乏力","气短懒言","半身不遂"] },
    "syn_154": { keySymptoms: ["干咳无痰","鼻咽干燥","口渴"] },
    "syn_155": { keySymptoms: ["身热烦渴","小便不利","头身困重"] },
    "syn_156": { keySymptoms: ["胸胁胀满疼痛","纳呆腹胀","便溏"] },
    "syn_157": { keySymptoms: ["身热夜甚","心烦不寐","斑疹隐隐"] },
    "syn_158": { keySymptoms: ["神疲乏力","气短懒言","汗多口渴"] },
    "syn_159": { keySymptoms: ["脓成难溃","疮口久不收敛","神倦食少"] },
    "syn_160": { keySymptoms: ["阵发腹痛","吐蛔或便蛔","发作有时"] }
};
